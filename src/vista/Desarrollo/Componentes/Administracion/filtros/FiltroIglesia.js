                                ...
                                listaVisible.map((igle, index) => {
                                    ...
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td>{(igle.Correo != null && igle.Correo != '') ? (<a href={`mailto:${igle.Correo}`}> Click</a>) : ('')}</td>
                                            <td>{(igle.Facebook != null && igle.Facebook != '') ? (<a href={igle.Facebook}> Click</a>) : ('')}</td>
                                            <td>{(igle.NumeroCelular != null && igle.NumeroCelular != '') ? (<a href={`https://api.whatsapp.com/send?phone=591${igle.NumeroCelular}`}></a>) : ('')}</td>
