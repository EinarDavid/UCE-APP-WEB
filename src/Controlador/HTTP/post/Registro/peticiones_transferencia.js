...
function peticion() {
    ...
    this.funciones = (bd, ver) => {
        ...
        this.rutas.post("/Registro/Transferencia", ver.verificarAdmin, (req, res) => {
            //ingresar los datos
        ...
        this.rutas.post("/Membresia/Modificar/Transferencia/:id", ver.verificarAdmin, (req, res) => {
            upload(req, res, function (err) {
                ...
                if (err) {
                    ...
                    var iglesia= req.body.iglesia;
                    var carta_de_transferencia = req.body.carta_de_transferencia;
                    var foto;
                    ...
                    var datos = [
                        ...
                        iglesia,
                        carta_de_transferencia

                    ];
                    bd.cruds.crudMembresiaTransferencia.actualizar(datos, id, () => {
